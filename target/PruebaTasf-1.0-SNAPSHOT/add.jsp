            ...
            <div class="card p-3 text-center">
                <form action="insert" method="POST">
                    ...
                    <div class="form-group text-start">
                        ...
                        <input type="text" class="form-control" name="des_prod" required/>
                    </div>
                    <div class="form-group text-start my-3">
                        <label>Cantidad:</label>
                        <input id="quantity" type="number" class="form-control" name="quantity" onchange="getTotal()" required/>
                    </div>
                    <div class="form-group text-start my-3">
                        <label>Precio unitario:</label>
                        <input id="uni_price" type="number" class="form-control" name="uni_price" onchange="getTotal()" required/>
                    </div>
                    <div class="form-group text-start my-3">
                        <label>Total:</label>
                        <input id="total" type="number" class="form-control" name="total" disabled required/>
                    </div>
